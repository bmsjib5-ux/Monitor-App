...
async def send_unsent_line_alerts_loop():
    ...
    while True:
        try:
            ...
            # Build hostname โ’ hospital_name lookup from monitored_processes
...
async def update_process_metadata(process_name: str, metadata: ProcessMetadataUpdate):
    ...
    try:
        ...
        if not metadata.hospital_code:
            raise HTTPException(status_code=400, detail="Hospital code is required (เธฃเธซเธฑเธชเธชเธ–เธฒเธเธเธขเธฒเธเธฒเธฅเธซเนเธฒเธกเธงเนเธฒเธ)")
        ...
        response = {
            "message": f"เธเธฑเธเธ—เธถเธเธเนเธญเธกเธนเธฅเธชเธณเน€เธฃเนเธ",
            "hospital_code": metadata.hospital_code,
            "hospital_name": metadata.hospital_name,
            "program_path": metadata.program_path,
        ...
        if supabase_error:
            response["supabase_warning"] = "เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธเธฑเธเธ—เธถเธเนเธเธขเธฑเธ Cloud เนเธ”เน (เธเนเธญเธกเธนเธฅเธ–เธนเธเธเธฑเธเธ—เธถเธเนเธเน€เธเธฃเธทเนเธญเธเนเธฅเนเธง)"
        return response
    except HTTPException:
        raise
    except Exception as e:
        logger.error(f"Error updating process metadata: {e}")
        raise HTTPException(status_code=500, detail="เน€เธเธดเธ”เธเนเธญเธเธดเธ”เธเธฅเธฒเธ”เนเธเธเธฒเธฃเธเธฑเธเธ—เธถเธเธเนเธญเธกเธนเธฅ เธเธฃเธธเธ“เธฒเธฅเธญเธเนเธซเธกเนเธญเธตเธเธเธฃเธฑเนเธ")
...
async def query_process_history_latest(hostname: str = None, hospital_code: str = None):
    """Get latest process_history record per (process_name, hospital_code) โ€” deduped at backend.
...
async def debug_line_oa():
    ...
    issues = []
    if not has_token:
        issues.append("โ เนเธกเนเธกเธต Channel Access Token - เธ•เนเธญเธเธ•เธฑเนเธเธเนเธฒเนเธ Master Mode")
    if not is_enabled:
        issues.append("โ LINE OA เธ–เธนเธเธเธดเธ”เนเธเนเธเธฒเธ (enabled=false)")
    if not has_recipients:
        issues.append("โ เนเธกเนเธกเธต User ID เธซเธฃเธทเธญ Group ID - เธ•เนเธญเธเน€เธเธดเนเธก bot เน€เธเนเธเน€เธเธทเนเธญเธเนเธฅเธฐเธชเนเธเธเนเธญเธเธงเธฒเธกเธกเธฒ")
    if not service_configured:
        issues.append("โ Service เธขเธฑเธเนเธกเนเธเธฃเนเธญเธกเนเธเนเธเธฒเธ - เธฅเธญเธ Restart Backend เธซเธฃเธทเธญ Sync LINE Settings")

    if not issues:
        issues.append("โ… LINE OA เธเธฃเนเธญเธกเนเธเนเธเธฒเธ")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return {
                ...
                "message": f"เน€เธเธทเนเธญเธกเธ•เนเธญเธชเธณเน€เธฃเนเธ: {data.get('displayName', 'LINE OA')}"
            }
        else:
            return {
                "success": False,
                "message": f"เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเนเธ”เน (HTTP {response.status_code})"
            }
    except Exception as e:
        logger.error(f"Error testing LINE token: {e}")
        return {"success": False, "message": f"เน€เธเธดเธ”เธเนเธญเธเธดเธ”เธเธฅเธฒเธ”: {str(e)}"}
...
async def send_line_from_alerts(alert_type: str = "PROCESS_STARTED", limit: int = 10):
    ...
    """
    if not line_notify_service.is_configured():
        return {"success": False, "message": "LINE OA เธขเธฑเธเนเธกเนเนเธ”เนเธ•เธฑเนเธเธเนเธฒ"}
    ...
    try:
        ...
        if not alerts:
            return {"success": True, "message": f"เนเธกเนเธเธ alerts เธเธฃเธฐเน€เธ เธ— {alert_type}", "sent": 0}
        ...
        return {
            ...
            "message": f"เธชเนเธเนเธเนเธเน€เธ•เธทเธญเธเธชเธณเน€เธฃเนเธ {sent_count}/{len(alerts)} เธฃเธฒเธขเธเธฒเธฃ",
            "sent": sent_count,
            "total": len(alerts),
...
async def send_unsent_line_alerts(alert_type: str = None, limit: int = 10):
    ...
    try:
        ...
        if not alerts:
            msg = f"เนเธกเนเธเธ alerts เธ—เธตเนเธขเธฑเธเนเธกเนเนเธ”เนเธชเนเธ"
            if alert_type:
                msg += f" เธเธฃเธฐเน€เธ เธ— {alert_type}"
...
async def send_process_alerts_from_supabase(limit: int = 50):
    ...
    try:
        ...
        if not line_settings:
            return {
                "success": False,
                "message": "เนเธกเนเธเธเธเธฒเธฃเธ•เธฑเนเธเธเนเธฒ LINE เนเธ Supabase",
                "sent": 0
            }
        ...
        if not line_settings.get("enabled", False):
            return {
                "success": False,
                "message": "LINE notification เธ–เธนเธเธเธดเธ”เธญเธขเธนเน",
                "sent": 0
            }
        ...
        if not channel_access_token:
            return {
                "success": False,
                "message": "เนเธกเนเธเธ Channel Access Token",
                "sent": 0
            }
        ...
        if not user_ids and not group_ids:
            return {
                "success": False,
                "message": "เนเธกเนเธเธ User ID เธซเธฃเธทเธญ Group ID เธชเธณเธซเธฃเธฑเธเธฃเธฑเธเธเนเธญเธเธงเธฒเธก",
                "sent": 0
            }
        ...
        if not alerts:
            return {
                "success": True,
                "message": "เนเธกเนเธเธ alerts เธ—เธตเนเธขเธฑเธเนเธกเนเนเธ”เนเธชเนเธ (PROCESS_STARTED/PROCESS_STOPPED)",
                "sent": 0,
                "total": 0
            }
        ...
        for alert in alerts:
            try:
                ...
                if success:
                    ...
                    errors.append(f"Alert {alert.get('id')}: เธชเนเธเนเธกเนเธชเธณเน€เธฃเนเธ")
...
async def get_global_line_settings():
    ...
    try:
        ...
        return {
            "success": False,
            "message": f"เน€เธเธดเธ”เธเนเธญเธเธดเธ”เธเธฅเธฒเธ”: {str(e)}"
        }
...
async def sync_line_settings():
    ...
    try:
        ...
        return {
            "success": True,
            "message": f"เธเธดเธเธเนเธเธฒเธฃเธ•เธฑเนเธเธเนเธฒ LINE เธชเธณเน€เธฃเนเธ (เธเธฒเธ {source_hostname})",
...
async def check_bms_and_send_alert(process_name: str = "BMSHOSxPLISServices"):
    ...
    """
    if not line_notify_service.is_configured():
        return {"success": False, "message": "LINE OA เธขเธฑเธเนเธกเนเนเธ”เนเธ•เธฑเนเธเธเนเธฒ", "alerts_sent": 0}
    ...
    try:
        ...
        if status.hosxp_db_status == 'disconnected':
            issues_found.append({
                ...
                "message": f"HOSxP DB เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเนเธ”เน: {status.hosxp_db_last_error or 'Unknown error'}"
            })
        ...
        if status.gateway_db_status == 'disconnected':
            issues_found.append({
                "type": "DB_DISCONNECTED",
                "message": f"Gateway DB เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเนเธ”เน: {status.gateway_db_last_error or 'Unknown error'}"
            })
        ...
        if status.gateway_status == 'stopped':
            issues_found.append({
                ...
                "message": "Gateway เธซเธขเธธเธ”เธ—เธณเธเธฒเธ"
            })
        ...
        if status.heartbeat_stale and status.gateway_status != 'stopped':
            issues_found.append({
                "type": "GATEWAY_ERROR",
                "message": "Gateway เนเธกเนเธ•เธญเธเธชเธเธญเธ (Heartbeat เธซเธขเธธเธ”)"
            })
...
async def send_bms_alert(request: BMSAlertRequest):
    ...
    try:
        ...
        if not message:
            alert_messages = {
                "DB_DISCONNECTED": "เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเธเธฒเธเธเนเธญเธกเธนเธฅเนเธ”เน",
                "GATEWAY_STOPPED": "Gateway เธซเธขเธธเธ”เธ—เธณเธเธฒเธ",
                "GATEWAY_ERROR": "Gateway เธเธเธเนเธญเธเธดเธ”เธเธฅเธฒเธ”",
                "GATEWAY_STARTED": "Gateway เน€เธฃเธดเนเธกเธ—เธณเธเธฒเธเนเธฅเนเธง",
                "CUSTOM": "เนเธเนเธเน€เธ•เธทเธญเธเธเธฒเธ BMS Gateway"
            }
        ...
        if success:
            ...
            return {"success": True, "message": "เธชเนเธเนเธเนเธเน€เธ•เธทเธญเธเธชเธณเน€เธฃเนเธ"}
        else:
            return {"success": False, "message": "เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธชเนเธเนเธเนเธเน€เธ•เธทเธญเธเนเธ”เน"}
...
async def send_bms_db_alert(
    ...
    try:
        ...
        message = error_message or f"{db_name} DB เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เน€เธเธทเนเธญเธกเธ•เนเธญเนเธ”เน"
        ...
        return {
            "success": success,
            "message": "เธชเนเธเนเธเนเธเน€เธ•เธทเธญเธเธชเธณเน€เธฃเนเธ" if success else "เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธชเนเธเนเธเนเธเน€เธ•เธทเธญเธเนเธ”เน",
            "db_type": db_type
        }
...
async def send_bms_gateway_alert(
    ...
    try:
        status_messages = {
            "stopped": ("GATEWAY_STOPPED", "Gateway เธซเธขเธธเธ”เธ—เธณเธเธฒเธ"),
            "started": ("GATEWAY_STARTED", "Gateway เน€เธฃเธดเนเธกเธ—เธณเธเธฒเธเนเธฅเนเธง"),
            "error": ("GATEWAY_ERROR", "Gateway เธเธเธเนเธญเธเธดเธ”เธเธฅเธฒเธ”")
        }
    ...
    try:
        ...
        if subscription:
            ...
            success = await push_svc.send_notification(
                ...
                title="เธ—เธ”เธชเธญเธเธเธฒเธฃเนเธเนเธเน€เธ•เธทเธญเธ",
                body="Push Notification เธ—เธณเธเธฒเธเธเธเธ•เธด!",
            ...
            sent = await push_svc.send_alert_notification(
                ...
                message="เธ—เธ”เธชเธญเธเธเธฒเธฃเนเธเนเธเน€เธ•เธทเธญเธ Push Notification",
...
# Get frontend dist path (client-app/dist relative to backend folder)
